	...
	return (
		<ScrollView style={{flex: 1}}>
            ...
            <View style={styles.textContainer}>
                <Text style={{color : 'white', marginBottom : 10, fontSize : 24, textAlign : 'center'}}>Today's prompt is </Text>
                <Text style={{ fontWeight : 'bold', textTransform : 'uppercase', fontSize : 40, color : 'white', textAlign : 'center'}}>{dailyRandomPrompt}</Text>
            </View>
            <View style={styles.textContainer}>
				<Text style={{color : 'white', marginBottom : 10, fontSize : 20, textAlign : 'center'}}>Don't like it?</Text>
                <Pressable style={[styles.button, {backgroundColor : '#FFD700',  paddingVertical: 10, paddingHorizontal: 20 }]} onPress={handleNewPrompt}>
					<Text style={[styles.buttonText, {backgroundColor : '#FFD700'}]}>Generate a new prompt</Text>
				</Pressable>
